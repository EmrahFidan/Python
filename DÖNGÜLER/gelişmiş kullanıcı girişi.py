# döngülerle gelişmiş bir kullanıcı girişi
print("**********\nKullanıcı Girişi\n**********\n")

# Kullanıcı Adı Girişi örneğinin gerçek versiyonunu PyQT5 derslerinde bulabilirsiniz.

sys_kul_adı = "emrah" # Sistemde Kayıtlı Olduğunu Düşündüğümüz Kullanıcı Adı

sys_parola  = "15082002" # Sistemde Kayıtlı Olduğunu Düşündüğümüz Parola
